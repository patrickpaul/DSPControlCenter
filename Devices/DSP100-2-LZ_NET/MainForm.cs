...
namespace DSP100_2_LZ_NET
{
    public partial class MainForm : MainForm_Template
    {
        ...
        {
            return DeviceType.DSP1002LZNet;
        }

        public override DeviceFamily GetDeviceFamily()
        {
            return DeviceFamily.DSP100NET;
        }
        ...
        {
            return @"Devices\DSP100-2-LZ-NET_Default.scfg";
        }
        ...
        public override void Single_Default_DSP_Program(int program_index = 0)
        {
            try {
                ...
                DSP_PROGRAMS[program_index].RegisterNewPrimitive(48, new DSP_Primitive_Ducker6x6("Ducker 6x6", 0, 0, 567));
