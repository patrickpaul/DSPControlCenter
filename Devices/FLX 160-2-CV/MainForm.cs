...
namespace FLX160_2_CV_Analog
{
    public partial class MainForm : MainForm_Template
    {
            ...
            : base("")
        {
            ...
            this.AmplifierMode = 1; // 2 Channel
        }
        ...
        {
            return @"Devices\FLX160-2-cv-Analog_Default.scfg";
        }
        ...
        public override void Default_DSP_Meters()
        {
            try
            {
                ...
                // Ducker
                DSP_METER_MANAGER.RegisterNewMeter(new DSP_Meter(0xF0C000FF, DSP_Primitive_Type.Ducker4x4, 0));
                DSP_METER_MANAGER.RegisterNewMeter(new DSP_Meter(0xF0C00103, DSP_Primitive_Type.Ducker4x4, 1));
                DSP_METER_MANAGER.RegisterNewMeter(new DSP_Meter(0xF0C00107, DSP_Primitive_Type.Ducker4x4, 2));
                DSP_METER_MANAGER.RegisterNewMeter(new DSP_Meter(0xF0C0010B, DSP_Primitive_Type.Ducker4x4, 3));
                ...
                int crosspoint_gain = 0;
                    ...
                    for (int out_channel = 0; out_channel < 8; out_channel++)
                    {
                        for (int in_channel = 0; in_channel < 10; in_channel++)
                        {
                            ...
                            ((out_channel == 2) && (in_channel == 1 || in_channel == 3 || in_channel == 5)))
                            ? 0 : -100;
