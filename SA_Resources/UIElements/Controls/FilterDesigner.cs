    ...
    public partial class FilterDesigner : UserControl
    {
        ...
        protected void OnChangeEvent(FilterEventArgs e)
        {
            if (this.OnChange != null)
            {
                ...
                {
                    Console.WriteLine("Exception in FilterDesigner.OnChangeEvent: " + ex.Message);
                }
            }
        }
        ...
        protected void OnDragBeginEvent(EventArgs e)
        {
            if (this.OnDragBegin != null)
            {
                ...
                {
                    Console.WriteLine("Exception in FilterDesigner.OnDragBeginEvent: " + ex.Message);
                }
            }
        }
        ...
        protected void OnDragEndEvent(EventArgs e)
        {
            if (this.OnDragEnd != null)
            {
                ...
                {
                    Console.WriteLine("Exception in FilterDesigner.OnDragEndEvent: " + ex.Message);
                }
            }
        } 
