...
{
    public partial class MixerForm8x4 : Form
    {
        ...
        public MixerForm8x4(MainForm_Template _parentForm)
        {
            InitializeComponent();
        ...
        private void MixerForm8x4_FormClosing(object sender, FormClosingEventArgs e)
        {
            gainMeter1.Stop();
            gainMeter2.Stop();
            gainMeter3.Stop();
