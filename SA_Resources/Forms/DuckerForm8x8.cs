        ...
        public DuckerForm8x8(MainForm_Template _parentForm, DSP_Primitive _inputPrimitive)
        {
            ...
            try
            {
                ...
                if (_parentForm.LIVE_MODE && _parentForm.DeviceConn.isOpen)
                {
                    ...
                    duckMeter2.Address = PARENT_FORM.DSP_METER_MANAGER.LookupMeter(DSP_Primitive_Type.Ducker8x8, 1, 0).Address;
                    duckMeter2.DeviceConn = PARENT_FORM.DeviceConn;
                    duckMeter2.Start();

                    duckMeter3.Address = PARENT_FORM.DSP_METER_MANAGER.LookupMeter(DSP_Primitive_Type.Ducker8x8, 2, 0).Address;
                    duckMeter3.DeviceConn = PARENT_FORM.DeviceConn;
                    duckMeter3.Start();

                    duckMeter4.Address = PARENT_FORM.DSP_METER_MANAGER.LookupMeter(DSP_Primitive_Type.Ducker8x8, 3, 0).Address;
                    duckMeter4.DeviceConn = PARENT_FORM.DeviceConn;
                    duckMeter4.Start();

                    duckMeter5.Address = PARENT_FORM.DSP_METER_MANAGER.LookupMeter(DSP_Primitive_Type.Ducker8x8, 4, 0).Address;
                    duckMeter5.DeviceConn = PARENT_FORM.DeviceConn;
                    duckMeter5.Start();

                    duckMeter6.Address = PARENT_FORM.DSP_METER_MANAGER.LookupMeter(DSP_Primitive_Type.Ducker8x8, 5, 0).Address;
                    duckMeter6.DeviceConn = PARENT_FORM.DeviceConn;
                    duckMeter6.Start();

                    duckMeter7.Address = PARENT_FORM.DSP_METER_MANAGER.LookupMeter(DSP_Primitive_Type.Ducker8x8, 6, 0).Address;
                    duckMeter7.DeviceConn = PARENT_FORM.DeviceConn;
                    duckMeter7.Start();

                    duckMeter8.Address = PARENT_FORM.DSP_METER_MANAGER.LookupMeter(DSP_Primitive_Type.Ducker8x8, 7, 0).Address;
