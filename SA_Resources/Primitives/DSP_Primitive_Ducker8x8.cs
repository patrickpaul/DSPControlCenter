...
{
    public class DSP_Primitive_Ducker8x8 : DSP_Primitive, ICloneable
    {
        ...
        public DSP_Primitive_Ducker8x8(string in_name, int in_channel, int in_positionA, int in_plainvalue_offset)
            : base(in_name, in_channel, in_positionA)
        {
            ...
            this.Type = DSP_Primitive_Types.Ducker8x8;
            this.Num_Values = 22;
        ...
        public DSP_Primitive_Ducker8x8(string in_name, int in_channel, int in_positionA, int in_plainvalue_offset, double in_thresh, double in_depth, double in_attack, double in_release, double in_holdtime, bool in_bypassed, int in_priority = 0)
            : base(in_name, in_channel, in_positionA)
        {
            INDUCK_Values = new List<UInt32>();
            OUTDUCK_Values = new List<UInt32>(); 
        ...
        public override void QueueChange(MainForm_Template PARENT_FORM)
        {
            ...
            {
                Console.WriteLine("Ducker8x8 - QueueChange - Sending " + this.Values[i].ToString("X") + " to offset " + (Offset + i));
            }
        ...
        public override void QueueChangeByOffset(MainForm_Template PARENT_FORM, int const_offset)
        {
            ...
            if (PARENT_FORM.LIVE_MODE)
            {
                Console.WriteLine("Ducker8x8 - QueueChangeByOffset - Sending " + this.Values[const_offset].ToString("X8") + " to offset " + (Offset + const_offset));
        ...
        public override void QueueDeltas(MainForm_Template PARENT_FORM, DSP_Primitive comparePrimitive)
        {
            ...
            DSP_Primitive_Ducker8x8 RecastPrimitive = (DSP_Primitive_Ducker8x8)comparePrimitive;
