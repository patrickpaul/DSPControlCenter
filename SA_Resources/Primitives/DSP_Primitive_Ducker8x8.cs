...
namespace SA_Resources.DSP.Primitives
{
    public class DSP_Primitive_Ducker8x8 : DSP_Primitive, ICloneable
    {
        ...
        public DSP_Primitive_Ducker8x8(string in_name, int in_channel, int in_positionA)
        ...
        public DSP_Primitive_Ducker8x8(string in_name, int in_channel, int in_positionA, double in_thresh, double in_depth, double in_attack, double in_release, double in_holdtime, bool in_bypassed, int in_priority = 0)
            : base(in_name, in_channel, in_positionA)
        {
            INDUCK_Values = new List<UInt32>();
            OUTDUCK_Values = new List<UInt32>(); 
        ...
        {
            Console.WriteLine("Ducker8x8 - QueueChangeByOffset - Sending " + this.Values[const_offset].ToString("X") + " to offset " + (Offset + const_offset));
